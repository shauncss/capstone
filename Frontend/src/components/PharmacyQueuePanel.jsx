    ...
    <>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            <h3>Pharmacy Counter</h3>
          </div>
        </div>

        <div className="admin-card-lux info" style={{ padding: '1.5rem', margin: '0', textAlign: 'center' }}>
          <p className="helper-text" style={{ marginBottom: '0.5rem' }}>CURRENT TICKET</p>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <p className="muted">Waiting List ({waitingQueue.length})</p>
          </div>
        </div>
